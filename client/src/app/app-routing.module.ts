...
const routes: Routes = [
  ...
  {
    path: 'shop', loadChildren: () => import('./shop/shop.module').then(mod => mod.ShopModule), // *** Lazy loading of shop module. ***
  ...
  {
    path: 'account', loadChildren: () => import('./account/account.module').then(mod => mod.AccountModule), // *** Lazy loading of account module. ***
